...
String action = "NONE";
// Fatigue
if (contextInsight == "POSSIBLE_FATIGUE") {
    action = "TAKE_BREAK";
}

// Unusual silence
else if (contextInsight == "UNUSUAL_SILENCE") {
    action = "CHECK_IN";
}

// Disturbance
else if (contextInsight == "SUDDEN_DISTURBANCE") {
    action = "REDUCE_NOISE";
}

// Instability
else if (contextInsight == "UNSTABLE_BEHAVIOR") {
    action = "CALM_ENVIRONMENT";
}

// High engagement
else if (contextInsight == "HIGH_ENGAGEMENT") {
...
Serial.print(",");
Serial.print(contextInsight);
Serial.print(",");
Serial.println(action);// ONLY println at end
  // Serial.print("Amp: ");
  // Serial.print(smoothAmp);
  // Serial.print(" | State: ");
